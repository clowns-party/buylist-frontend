 ...
 * });
 */
export function useGetBuylistByIdQuery(
  ...
  return Apollo.useQuery<GetBuylistByIdQuery, GetBuylistByIdQueryVariables>(
    GetBuylistByIdDocument,
    options
  );
}
export function useGetBuylistByIdLazyQuery(
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<GetBuylistByIdQuery, GetBuylistByIdQueryVariables>(
    GetBuylistByIdDocument,
    options
  );
}
export type GetBuylistByIdQueryHookResult = ReturnType<
  typeof useGetBuylistByIdQuery
>;
export type GetBuylistByIdLazyQueryHookResult = ReturnType<
  typeof useGetBuylistByIdLazyQuery
>;
export type GetBuylistByIdQueryResult = Apollo.QueryResult<
  GetBuylistByIdQuery,
  GetBuylistByIdQueryVariables
>;
